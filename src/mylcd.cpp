...
void testLCD() {
  ...
  //  }
  //  tft.sendCommand(0xB0,0);
  //  int r1= tft.readcommand8(LCD_READ_ID,0);
  //   debug_printf("%08x ",r1);
  //     r1= tft.readcommand8(0,1);
  //   debug_printf("%08x ",r1);
  //    r1= tft.readcommand8(0,2);
  //   debug_printf("%08x ",r1);
...
LCDThread::LCDThread() : BaseThread(){
  ...
  // testLCD();
    // dbg=new LCDTBT();
  // eventSystem.addListener(EventType::ENCODER_CLICK,LCDThread::onEncoderClick);
...
// bool LCDThread::onEncoderClick(EventData *data) {
//   debug_printf("Call back on click \n");
//   return false;
// }
